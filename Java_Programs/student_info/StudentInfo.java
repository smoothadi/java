...
class StudentInfo {
    public static void main(String[] args) throws IOException {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("student_marks.txt"))) {
            writer.write("Name: " + name + "\nAge: " + age + "\nMarks:\n");
            writer.write("Java: " + javaMarks + "\nRDBMS: " + rdbmsMarks + "\nOS:" + osMarks);
        }
        // Reading and displaying student data from file
        BufferedReader reader = new BufferedReader(new FileReader("student_marks.txt"));
